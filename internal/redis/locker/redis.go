...
type Option func(l *RedisLocker)
...
//		log.Fatal(err)
//	}
func NewFromClient(client redis.UniversalClient, lockerOptions ...Option) (*RedisLocker, error) {
...
// Example usage:
//
//	locker, err := locker.New("redis://localhost:6379")
//	if err != nil {
//		log.Fatal(err)
//	}
//
//	// With authentication:
//	locker, err := locker.New("redis://user:pass@localhost:6379/0")
//	if err != nil {
//		log.Fatal(err)
//	}
func New(uri string, lockerOptions ...Option) (*RedisLocker, error) {
